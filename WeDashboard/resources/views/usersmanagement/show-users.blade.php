...
@section('content')
    <section class="page-header-title">
        <h4 class="page-title">{!! trans('usersmanagement.showing-all-users') !!}</h4> 
   </section>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped  data-table">
                                <caption class="ml-3" id="user_count">
                            ...
                            <div class="text-center">
                                @if(config('usersmanagement.enablePagination'))
                                    {{ $users->links() }}
                                    <p>{{ 'Showing '.$users->firstitem().' - '.$users->lastitem().' of '.$users->total().' results ('.$users->perPage().' per page)'}}</p>
                                @endif
                            </div>
                        </div>
                    </div>
