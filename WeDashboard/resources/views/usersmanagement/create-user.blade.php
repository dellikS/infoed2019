...
@section('content')
    <section class="page-header-title">
        <h4 class="page-title">{!! trans('usersmanagement.create-new-user') !!}</h4> 
   </section>
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'users.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('phone') ? ' has-error ' : '' }}">
                                {!! Form::label('phone', trans('forms.create_user_label_phone'), array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('phone', NULL, array('id' => 'phone', 'class' => 'form-control', 'placeholder' => trans('forms.create_user_ph_phone'))) !!}
                                    </div>
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('country_id') ? ' has-error ' : '' }}">
                                {!! Form::label('country_id', trans('forms.create_user_label_country_id') , array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                            ...
                            {!! Form::button(trans('forms.create_user_button_text'), array('class' => 'btn btn-primary margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                        {!! Form::close() !!}
                    </div>
