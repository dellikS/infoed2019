            ...
            <div class="row content">
                <div class="col">
                    <div class="profile-info float-left">
                        <h4 id="user-name">{!! trans('usersmanagement.editing-user', ['name' => $user->name]) !!} <small> @if ($user->id == Auth::user()->id) (You)  @endif </small> </h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('country_id') ? ' has-error ' : '' }}">
                                {!! Form::label('country_id', trans('profile.label-country_id') , array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select id="country_id" name="country_id" class="custom-select form-control">
                                            @if ($country_array)
