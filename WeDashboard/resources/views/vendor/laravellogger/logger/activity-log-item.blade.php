...
<!--('LaravelLogger::partials.scripts', ['activities' => $userActivities])-->
...
<section class="page-header-title">
    <h4 class="page-title">{{ trans('LaravelLogger::laravel-logger.drilldown.title', ['id' => $activity->id]) }}</h4> 
</section>

<div style="position: absolute;right: 0;z-index: 19;">
    <a href="@if($isClearedEntry) {{route('cleared')}} @else {{route('activity')}} @endif" class="btn btn-light btn-sm float-right" data-toggle="tooltip" title="{{ trans('usersmanagement.tooltips.back-users') }}">
